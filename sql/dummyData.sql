...
insert into event (eventName, startTime, endTime, description, location, roomID, ownerID)
	values 	('Systemtest', '2014-03-05 10:00:00', '2014-03-05 12:00:00',
						'Test av hele systemet', 'Paa Gloeshaugen', 1, 2),
			('Brukbarhetstest', '2014-03-06 11:00:00', '2014-03-06 13:00:00',
						'Test med 4 testpersoner', 'Paa Gloeshaugen', 2, 2);
...
insert into calendar.group() values ();
insert into calendar.group() values ();
insert into calendar.group() values ();
